...
class MM_SwinUnter_Segmentation(nn.Module):
    def __init__(self, n_class = 7, text_prompt = True, VL_CrossAttention = True, fusion_module="", text_prompt_name="CLIP_embedding", text_encoding="word_embedding", res_depth=50) -> None:
