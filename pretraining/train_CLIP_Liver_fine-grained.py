...
class ModelArguments:
    ...
    language_model_name_or_path: str = field(default="./BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext")
...
@dataclass
class DataArguments:
    data_root: str = field(default="./mm_pretrain_data/LLD_MMRI_data/images/npz_data/", metadata={"help": "Root directory for all data."})

    # caption data
    cap_data_path: str = field(default="./mm_pretrain_data/LLD_MMRI_data/liver_pretrain_fine-grained_nocrop.json", metadata={"help": "Path to caption data."})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    # config in bash file
    bf16: bool = True
    output_dir: str = "./LaMed/output/BioBert_zxg_fine-grained_nocrop_100epoches"
...
def main():
    ...
    # pretrain = "/research/d1/rshr/xgzhou/code/M3D/M3D/pretrained_model/supervised_suprem_swinunetr_2100.pth"
