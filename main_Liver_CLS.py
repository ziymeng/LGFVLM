...
from trainer_Liver_CLS import run_training
...
parser.add_argument("--logdir", default="liver_cls_", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
...
parser.add_argument('--CLIP_text_pretrain_dir', default=f"./Text-emmbedding-gen/Liver_clip_txt_encoding.pth", type=str)
parser.add_argument('--Bert_text_pretrain_dir', default=f"./Text-emmbedding-gen/Liver_bert_txt_encoding.pth", type=str)
...
parser.add_argument('--res_depth', default=101, type=int, choices=[18, 34, 50, 101, 152, 200])
...
def main():
    ...
    args.logdir = "./out_liver/" + args.logdir + "_" + args.text_prompt_name + "_" + args.fusion_module + "_" + sw_batch_size + "_" + use_text_prompt + "_" + text_prompt_loss
    if args.distributed:
